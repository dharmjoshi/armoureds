          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {products.map((product) => (
              <div key={product.id} className={`bg-white rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition-all duration-300 group ${
                product.popular ? 'ring-2 ring-blue-500 ring-opacity-50 transform scale-105' : ''
              }`}>
                {/* Product Image Placeholder */}
                <div className="relative h-48 bg-gradient-to-br from-blue-400 to-purple-500 overflow-hidden">
                  {product.popular && (
                    <div className="absolute top-4 right-4 bg-yellow-400 text-gray-900 px-3 py-1 rounded-full text-sm font-semibold animate-pulse">
                      Most Popular
                    </div>
                  )}
                ...
                <div className="p-6">
                  ...
                  <div className="flex flex-col sm:flex-row gap-3">
                    <Link 
                      ...
                      className={`flex-1 font-bold py-2 px-4 rounded-lg transition-all duration-200 text-center ${
                        product.popular 
                    ...
                    <button className="flex-1 border border-blue-600 text-blue-600 hover:bg-blue-600 hover:text-white font-bold py-2 px-4 rounded-lg transition-colors duration-200">
                      Try Free
                    </button>
                  </div>
                </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600">Find the perfect security solution for your needs</p>
          </div>
          ...
          <div className="bg-blue-50 rounded-lg p-8 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <button className="border border-blue-600 text-blue-600 hover:bg-blue-600 hover:text-white font-bold py-3 px-8 rounded-lg transition-colors duration-200">
